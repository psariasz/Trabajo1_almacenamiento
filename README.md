...
Para lectura completa del trabajo, y de la implementación de un datalake y procesamiento con el uso de herramientas en AWS, puyede referirse al siguiente documento: 
